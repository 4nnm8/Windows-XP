var minesweeper = {
  ...
  newGame: function(level, numRows, numCols, numMines, resetting) {
    ...
    //window.parent.resizeWindowToFitContent("winmine")
  }, 
